...
func (obj *_SysUserMgr) WithUpdateBy(updateBy string) Option {
...
func (obj *_SysUserMgr) WithRemark(remark string) Option {
	return optionFunc(func(o *options) { o.query["remark"] = remark })
}

// WithPortalUserID portal_user_id获取 portal用户表主键
func (obj *_SysUserMgr) WithPortalUserID(portalUserID int64) Option {
...
func (obj *_SysUserMgr) GetFromUserID(userID int64) (result SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromUserID(userIDs []int64) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromDeptID(deptID int64) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromDeptID(deptIDs []int64) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromLoginName(loginName string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromLoginName(loginNames []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromUserName(userName string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromUserName(userNames []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromUserType(userType string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromUserType(userTypes []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromPhonenumber(phonenumber string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromPhonenumber(phonenumbers []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromSex(sex string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromSex(sexs []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromAvatar(avatar string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromAvatar(avatars []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromSalt(salt string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromSalt(salts []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromStatus(status string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromStatus(statuss []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromDelFlag(delFlag string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromDelFlag(delFlags []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromLoginIP(loginIP string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromLoginIP(loginIPs []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromLoginDate(loginDate time.Time) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromLoginDate(loginDates []time.Time) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromCreateBy(createBy string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromCreateBy(createBys []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromUpdateBy(updateBy string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromUpdateBy(updateBys []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromRemark(remark string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromRemark(remarks []string) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetFromPortalUserID(portalUserID int64) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) GetBatchFromPortalUserID(portalUserIDs []int64) (results []*SysUser, err error) {
...
func (obj *_SysUserMgr) FetchByPrimaryKey(userID int64) (result SysUser, err error) {
	err = obj.DB.WithContext(obj.ctx).Table(obj.GetTableName()).Where("user_id = ?", userID).Find(&result).Error
